package com.eventbus.complier.utils;

public class Constants {

    //注解处理器支持的注解类型
    public static final String SUBSCRIBE_ANNOTATION_TYPES = "com.eventbus.annotation.Subscribe";
    ...
    //所有的事件订阅方法，生成索引接口
    public static final String SUBSCRIBEINFO_INDEX = "com.eventbus.annotation.SubscriberInfoIndex";
